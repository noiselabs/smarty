<?php
    ...
    */
    class Smarty_Template_Cached
    {
        ...
        * @return
        */
        public function getRenderedTemplate($_template, $no_output_filter, $display)
        {
            $browser_cache_valid = false;
            if ($display && $_template->cache_modified_check && $_template->cached->valid && !$_template->has_nocache_code) {
            ...
            if (!$browser_cache_valid) {
                ...
                if ($_template->has_nocache_code  && !$no_output_filter && (isset($_template->autoload_filters['output']) || isset($_template->registered_filters['output']))) {
        ...
        public function setModifiedHeader() {           
            switch (PHP_SAPI) {
                case 'cli':
                    if ( /* ^phpunit */
                        !empty($_SERVER['SMARTY_PHPUNIT_DISABLE_HEADERS']) /* phpunit$ */
