...
abstract class Smarty_Resource
{
     ...
     */
    public abstract function populate(Smarty_Template_Source $source, Smarty $_template = null);
    ...
    public function populateCompiledFilepath(Smarty_Compiled $compiled, $_object)
    {
        ...
        // subtype
        if ($_object->usage == Smarty::IS_CONFIG) {
            $_subtype = '.config';
     ...
     */
    protected function buildFilepath(Smarty_Template_Source $source, Smarty $_template = null)
    {
        $file = $source->name;
        if ($_template->usage == Smarty::IS_CONFIG) {
        ...
        if ($_template && isset($_template->parent) && $_template->parent->usage == Smarty::IS_TEMPLATE && $_file_is_dotted) {
     ...
     */
    public static function source(Smarty $_template = null, Smarty $smarty = null, $template_resource = null)
    {
        if ($_template) {
            $smarty = $_template;
